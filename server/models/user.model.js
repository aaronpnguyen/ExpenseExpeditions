...
const UserSchema = new mongoose.Schema ({
    ...
    email: {
      ...
      validate: {
        validator: val => /^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9._-]+\.[a-zA-Z]+$/.test(val), //tests the value from form with this regular expression pattern to validate if the pattern is in an email format
